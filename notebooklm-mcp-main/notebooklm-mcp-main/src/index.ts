    ...
    this.server.setRequestHandler(CallToolRequestSchema, async (request) => {
      ...
      try {
        ...
        switch (name) {
          ...
          case "create_notebook_browser":
            result = await this.toolHandlers.handleCreateNotebook(
              args as { name: string; description: string; topics: string[]; show_browser?: boolean },
              sendProgress
            );
            break;
          ...
          case "add_source":
            result = await this.toolHandlers.handleAddSource(
              args as { notebook_id?: string; notebook_url?: string; source_path: string; show_browser?: boolean },
              sendProgress
            );
            break;

          case "update_instructions":
            result = await this.toolHandlers.handleUpdateInstructions(
              args as { notebook_id?: string; notebook_url?: string; instructions: string; show_browser?: boolean },
              sendProgress
            );
            break;
          ...
          case "remove_source":
            result = await this.toolHandlers.handleRemoveSource(
              args as { notebook_id?: string; notebook_url?: string; source_name: string; show_browser?: boolean },
              sendProgress
            );
            break;
