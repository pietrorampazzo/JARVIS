...
User: "Yes" → call remove_notebook`,
  ...
  {
    name: "create_notebook_browser",
    description: "Create a new notebook directly in the NotebookLM browser interface and add it to the local library.",
    inputSchema: {
      type: "object",
      properties: {
        name: {
        ...
        description: {
          type: "string",
          description: "A description of what this notebook will contain",
        },
        topics: {
          type: "array",
          items: { type: "string" },
          description: "Initial topics for this notebook",
        },
        show_browser: {
          type: "boolean",
          description: "Whether to show the browser window during creation (default: false)",
        },
      },
  ...
  {
    name: "add_source",
    description: "Add a new source (file or link) to a notebook via the browser interface.",
    inputSchema: {
      type: "object",
      properties: {
        notebook_id: {
          type: "string",
          description: "The local ID of the notebook",
        },
        notebook_url: {
          type: "string",
          description: "The direct NotebookLM URL",
        },
        source_path: {
          type: "string",
          description: "Absolute path to the file or a URL to add as a source",
        },
        show_browser: {
          type: "boolean",
  ...
  },
  {
    ...
    description: "Update the custom instructions for a notebook via the browser interface.",
    inputSchema: {
      type: "object",
      properties: {
        notebook_id: {
        ...
        instructions: {
          type: "string",
          description: "The new system instructions for the notebook",
        },
        show_browser: {
          type: "boolean",
          description: "Whether to show the browser window (default: false)",
  ...
  {
    name: "remove_source",
    description: "Remove a source from a notebook via the browser interface.",
    inputSchema: {
      type: "object",
      properties: {
        notebook_id: {
