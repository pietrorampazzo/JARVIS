...
INVENTORY_DIR = BASE_DIR / "cos" / "integrations" / "inventory"

# Pastas alvo (Google Drive)
TARGET_PATHS = {
    "ARTE": Path(r"I:\Meu Drive\arte_comercial\PROPOSTAS"),
    "PIEZZO": Path(r"I:\Meu Drive\PIEZZO\PPROPOSTAS")
}
