...
Registra logs em: cos/logs/openclaw_watchdog.log
"""
...
LOG_PATH = BASE_DIR / "cos" / "logs" / "openclaw_watchdog.log"
...
def notify_jarvis(message: str):
    ...
    try:
        notifier_path = BASE_DIR / "cos" / "integrations" / "openclaw_notifier.py"
