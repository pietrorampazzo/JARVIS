...
import AtaCardDetalhado from "../components/atas/AtaCardDetalhado";
import AtaFilters from "../components/atas/AtaFilters";
import { motion } from "framer-motion";
import { FileText, Search } from "lucide-react";

export default function AtasPage() {
    const [atas, setAtas] = React.useState<any[]>([]);
        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white py-12">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <h1 className="text-5xl font-bold text-gray-900 mb-6">Atas Governamentais Vigentes</h1>
                ...
                {isLoading ? (
                    ...
                    >
                        ...
                        <h3 className="text-2xl font-semibold text-gray-900 mb-4">Nenhuma ata encontrada</h3>
