            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    <div className="flex items-center justify-center mb-6">
                        <div className="rounded-xl bg-white p-6 shadow-sm border border-gray-100 flex items-center justify-center">
                            <img src="/images/logo.png" alt="Arte Comercial Logo" className="h-24 md:h-32 object-contain" />
                        </div>
                    </div>
                    <h1 className="text-5xl font-bold text-gray-900 mb-6">Marcas Representadas</h1>
                ...
                {isLoading ? (
                            ...
                            >
                                <Card className="group hover:shadow-2xl transition-all duration-500 border-0 bg-white/90 backdrop-blur-sm h-full">
                                    <CardHeader className="text-center pb-6">
                                        <div className="w-full h-32 flex items-center justify-center mb-6 bg-white rounded-xl overflow-hidden p-4">
                                            {marca.logo_url ? (
                                                <>
                                                    <img
                                                        src={marca.logo_url}
                                                        alt={marca.nome}
                                                        className={`w-full h-full object-contain transition-transform duration-300 ${['Vandoren', 'Evans'].includes(marca.nome)
                                                                ? 'scale-[1.8] group-hover:scale-[2]'
                                                    ...
                                                    />
                                                    <div className="hidden text-3xl font-bold bg-gradient-to-r from-blue-600 to-blue-800 text-transparent bg-clip-text">
                                                        {marca.nome}
                                                    </div>
                                                </>
                                            ) : (
                                        ...
                                        <h3 className="text-2xl font-bold text-gray-900 mb-2">{marca.nome}</h3>
                    ...
                    >
                        ...
                        <h3 className="text-2xl font-semibold text-gray-900 mb-4">Nenhuma marca encontrada</h3>
                ...
                >
                    <h2 className="text-3xl font-bold mb-4">Representação Oficial Autorizada</h2>
