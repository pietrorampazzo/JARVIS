    ...
    const informacoesContato = [
        {
            ...
            title: "Telefone",
            info: "(11) 99410-3374",
            href: "https://wa.me/5511994103374",
        ...
        },
        {
            ...
            href: "mailto:pietro@artecomercialbrasil.com.br",
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
                    {informacoesContato.map((item, index) => (
                        ...
                        >
                            ...
                            {item.href ? (
                                <a href={item.href} target="_blank" rel="noopener noreferrer" className="text-blue-600 font-medium mb-1 break-words w-full text-sm hover:underline">
                                    {item.info}
                                </a>
                            ) : (
