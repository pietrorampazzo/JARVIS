...
from engine.shared.shared import get_config
...
def get_scores_range(days: int) -> list[dict]:
    ...
    for i in range(days):
        ...
        try:
            # Pula o inventory ao buscar histórico para análise de tendências
            score = calculate_daily_score(d, skip_inventory=True)
            scores.append(score)
        except Exception:
            pass
